...
export const useThemeStore = defineStore('theme', () => {
  ...
  const initializeTheme = () => {
    ...
    const savedTheme = localStorage.getItem('nwsinga-theme') as Theme
   ...
   */
  const saveTheme = () => {
    localStorage.setItem('nwsinga-theme', currentTheme.value)
  }

  // Watch for theme changes and save to localStorage
  const unwatchTheme = () => {
    // This will be called when the store is disposed
  }
